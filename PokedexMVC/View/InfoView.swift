...
//  PokedexMVC
//
//  Created by Дмитрий Папушин on 22/08/2019.
...
protocol InfoViewDelegate {
    // because we wanna pass this pokemon to the new Infoview controller but when I tap to the space area we don't need a pokemon and that's why I use Pokemon?
...
class InfoView: UIView {
    ...
    var pokemon: Pokemon? {
        didSet {
            ...
            // Integers will be presented as a String
...
//            print(pokemon.evolutionChain)
    ...
    @objc func handleViewMoreInfo() {
        // set the pokemon inside the Pokedex Controller
    ...
    func configureForPokemonInfoController() {
